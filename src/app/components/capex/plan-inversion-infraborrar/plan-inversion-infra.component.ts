...
@Component({
  selector: 'app-plan-inversion-infra',
  templateUrl: './plan-inversion-infra.component.html',
  styleUrls: ['./plan-inversion-infra.component.css']
})
export class PlanInversionInfraComponent {
  loading = false;
  edit: any = {};
  // table
