...
@Component({
  selector: 'app-proyeccion-precios',
  templateUrl: './proyeccion-precios.component.html',
  styleUrls: ['./proyeccion-precios.component.css'],
})

export class ProyeccionPreciosComponent {
  loading = false;
  edit: any = {};
  // table
  title = 'Proyección precios';
  nameDataResponse = 'incrementoPreciosAnuales';
  empresa_id: any = '';
  loaded = false;
  dataR: any;
  url_table = '';
  ...
  getEmpresa() {
    ...
    this.url_table = `${environment.api_url}proyprecios?empresa_id=${this.empresa_id}`;
    this.loaded = true;
  }
}
