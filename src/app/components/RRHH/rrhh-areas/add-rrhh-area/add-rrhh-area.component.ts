...
@Component({
  selector: 'app-add-rrhh-area',
  templateUrl: './add-rrhh-area.component.html',
  styleUrls: ['./add-rrhh-area.component.css']
})
export class AddRrhhAreaComponent {
  @Output()
  ...
  formC() {
    {
      this.form = this.formBuilder.group({
        id: [this.edit?.id],
        area: [this.edit?.area, [Validators.required]],
  ...
  store() {
    ...
    this.http
      .post(`${environment.api_url}areas`, this.form.value)
      .subscribe(
        (response: any) => {
