...
@Component({
  selector: 'app-add-anno-depreciar',
  templateUrl: './add-anno-depreciar.component.html',
  styleUrls: ['./add-anno-depreciar.component.css'],
})
export class AddAnnoDepreciarComponent {
  @Output()
  ...
  url = `${environment.api_url}depreciaciones`;
  ...
  formC() {
    {
      this.form = this.formBuilder.group({
        id: [this.edit?.id],
        year_depreciacion: [
          this.edit?.year_depreciacion,
          [Validators.required, this.validatorsS.number, Validators.minLength(4)],
        ],
