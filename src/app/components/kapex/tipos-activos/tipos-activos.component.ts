...
export class TiposActivosComponent {
  loading = false;
  edit: any = {};
  // table
  title = 'Tipos activos';
  nameDataResponse = 'tipoactivos';
  dataR: any;
  url_table = `${environment.api_url}tipoactivos`;
  columnsTable: any = [
    { name: 'Acc.', field: 'actions', type: '' },
    { name: 'Nombre', field: 'tipo', type: '' },
    { name: 'Años', field: 'annos', type: '' },
