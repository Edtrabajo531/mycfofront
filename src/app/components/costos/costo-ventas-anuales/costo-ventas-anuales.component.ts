...
@Component({
  selector: 'app-costo-ventas-anuales',
  templateUrl: './costo-ventas-anuales.component.html',
  styleUrls: ['./costo-ventas-anuales.component.css'],
})

export class CostoVentasAnualesComponent {
  loading = false;
  edit: any = {};
  // table
